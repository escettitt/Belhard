...
<input type="hidden" id="id" name="id" value="{{$post->id}}">
    ...
    <input type="text" id="header" class="input__post input_header" name="post_header" value="{{$post->header}}" placeholder="Название..." />
    ...
    <div class="button mt-2" id="submit">Сохранить</div>
</form>
